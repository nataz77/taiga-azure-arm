...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'Taiga'),
...
SITES = {
    "api": {"domain": os.environ.get('TAIGA_DOMAIN'), "scheme": "https", "name": "api"},
    "front": {"domain": os.environ.get('TAIGA_DOMAIN'), "scheme": "https", "name": "front"}
}
...
EMAIL_USE_SSL = os.getenv('EMAIL_SSL', 'True') == 'True'
...
EVENTS_PUSH_BACKEND_OPTIONS = {
    "url": f"amqp://{os.getenv('RABBITMQ_USER')}:{os.getenv('RABBITMQ_PASSWORD')}@{os.getenv('RABBITMQ_HOST')}:{os.getenv('RABBITMQ_PORT')}/taiga"
}
...
CELERY_BROKER_URL = f"amqp://{os.getenv('RABBITMQ_USER')}:{os.getenv('RABBITMQ_PASSWORD')}@{os.getenv('RABBITMQ_HOST')}:{os.getenv('RABBITMQ_PORT')}/taiga"
